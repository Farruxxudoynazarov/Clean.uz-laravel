                        ...
                        <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="col-sm-6 control-group  mb-3">
                                    <input type="text" class="form-control p-4" name="title" id="name" placeholder="Sarlahva" value="{{ old('title') }}"/>
                            ...
                            <div class="control-group mb-3">
                                <input type="text" class="form-control p-4" id="subject"  name="short_content" placeholder="Qisqacha mazmuni" value="{{ old('short_content') }}" />
                             @error('short_content')
                             <p class="help-block text-danger">{{ $message }}</p>
                             @enderror
