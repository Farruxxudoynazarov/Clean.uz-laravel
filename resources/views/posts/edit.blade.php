                        ...
                        <form action="{{ route('posts.update', ['post'=>$post->id]) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="col-sm-6 control-group  mb-3">
                                    <input type="text" class="form-control p-4" name="title" id="name" placeholder="Sarlahva" value={{ $post->title }}/>
                            ...
                            <div class="control-group mb-3">
                                <input type="text" class="form-control p-4" id="subject"  name="short_content" placeholder="Qisqacha mazmuni" value={{ $post->short_content }} />
                             @error('short_content')
                             <p class="help-block text-danger">{{ $message }}</p>
                             @enderror
                            ...
                            <div>
                                <input type="file" class="form-control p-4" name="photo" placeholder="imgni joylang">
                                @error('photo')
                                <p class="help-block text-danger">{{ $message }}</p>                                    
                                @enderror
